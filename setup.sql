...
create table price_data(
    ...
    changing double not null,
    change_over_time double not null,
    change_percent double not null,
    close double not null,
    high double not null,
    low double not null,
    open double not null,
    u_close double not null,
    u_high double not null,
    u_low double not null,
    u_open double not null,
...
create table book_data(
    ...
    iex_real_time_price int not null,
    iex_real_time_size bigint not null,
    iex_last_updated bigint not null,
    delayed_price double not null,
    delayed_price_time bigint not null,
    extended_price double not null,
    extended_change double not null,
    extended_change_percent double not null,
    extended_price_time bigint not null,
    previous_close double not null,
    changed double not null,
    change_percent double not null,
    iex_market_percent double,
    iex_volume double not null,
    avg_total_volume int not null,
    iex_bid_price int not null,
    iex_bid_size int not null,
    iex_ask_price int not null,
    iex_ask_size bigint not null,
    market_cap bigint not null,
    pe_ratio double not null,
    week_52_high double not null,
    week_52_low double not null,
    ytd_change double not null,
    foreign key (stock_id) references stock(id)
);
...
create table intraday_data(
    ...
    ticker varchar(255) not null,
    low double not null,
    market_average double not null,
    market_change_over_time double not null,
    market_close double not null,
    market_high double not null,
    market_low double not null,
    market_notional double not null,
    market_number_of_trades int not null,
    market_open double not null,
...
create table key_stats(
    id int not null auto_increment primary key,
    stock_id int not null,
    week_52_change double not null,
    week_52_high double not null,
    week_52_low double not null,
    market_cap bigint not null,
    employees int not null,
    day_200_moving_avg double not null,
    day_50_moving_avg double not null,
    doubleing bigint not null,
    avg_10_volume double not null,
    avg_30_volume double not null,
    ttm_EPS double not null,
    ttm_dividend_rate double not null,
    company_name varchar(255) not null,
    shares_outstanding bigint not null,
    max_change_percent double not null,
    year_5_change_percent double not null,
    year_2_change_percent double not null,
    year_1_change_percent double not null,
    ytd_change_percent double not null,
    month_6_change_percent double not null,
    month_3_change_percent double not null,
    month_1_change_percent double not null,
    day_30_change_percent double not null,
    day_5_change_percent double not null,
    next_dividend_date varchar(255) not null,
    divident_yield double not null,
